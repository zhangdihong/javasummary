 ...
 * <p>Title: FTPConstant.java</p>
 * <p/>
 * <p>Description: FTPConstant </p>
 * <p/>
...
public class FTPConstant {
    ...
    public static Map<Integer,String> REPLYCODE = new HashMap<>();
    ...
    static {
        ...
        REPLYCODE.put(221, "服务关闭控制连接。 如果适当请注销。");
        REPLYCODE.put(225, "数据连接打开,没有进行中的传输");
        REPLYCODE.put(226, "关闭数据连接。请求的文件操作已成功");
        REPLYCODE.put(227, "进入被动模式");
        REPLYCODE.put(230, "用户已登录，继续进行");
        REPLYCODE.put(250, "请求的文件操作正确，已完成。");
        REPLYCODE.put(257, "路径名已建立");
        REPLYCODE.put(332, "需要登录账户");
        ...
        REPLYCODE.put(532, "存储文件需要账户");
        REPLYCODE.put(550, "未执行请求的操作。文件不可用(列入，未找到文件，没有访问权限)");
        REPLYCODE.put(551, "请求的操作异常终止：位子的页面类型");
